-- Update GDPR audit system for full compliance
...
CHECK (event_type IN (
  ...
  'dpo_notification_sent',
  'supervisory_authority_notified'
));

-- Add data retention policy for GDPR compliance
-- Create function to cleanup old audit logs (keep for 7 years as per GDPR recommendation)
