-- Update get_unified_transcript_queue to include richer metadata
...
BEGIN
    ...
    WITH owned_transcripts AS (
        SELECT 
            ...
            t.deal_context,
            COALESCE(
                t.source_metadata->'webhook_payload'->'meeting_metadata'->>'file_name',
                t.source_metadata->'webhook_payload'->>'transcript_filename',
                t.source_metadata->>'original_filename',
                t.source_metadata->'webhook_payload'->'file'->>'name',
                t.source_metadata->'file'->>'name'
