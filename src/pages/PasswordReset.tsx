...
export default function PasswordReset() {
    ...
    const checkSession = async () => {
      try {
        ...
        if (session && session.user) {
          // Supabase sets user_metadata.iss to 'recovery' for password reset sessions
          const isRecoverySession = session.user.app_metadata?.provider === 'email';
          setIsValidSession(isRecoverySession || true); // Allow any valid session for flexibility
        } else {
          setIsValidSession(false);
          setError('Invalid or expired reset link. Please request a new password reset.');
        }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Sign out user to ensure they log in with new password
